...
# Load extracted data
with open(r'c:\Users\Administrator\Documents\这是什么\JK-temp\阅读器项目\红楼梦范例\分析结果\v33_extracted_data.json', 'r', encoding='utf-8') as f:
    extracted = json.load(f)

# Load emotion data
emo_data = []
with open(r'c:\Users\Administrator\Documents\这是什么\JK-temp\阅读器项目\红楼梦范例\分析结果\情绪分析数据\ch01-18_emotion_analysis.json', 'r', encoding='utf-8') as f:
    emo_data = json.load(f)
try:
    with open(r'c:\Users\Administrator\Documents\这是什么\JK-temp\阅读器项目\红楼梦范例\分析结果\情绪分析数据\ch19-20_emotion_analysis.json', 'r', encoding='utf-8') as f:
...
with open(r'c:\Users\Administrator\Documents\这是什么\JK-temp\阅读器项目\红楼梦范例\分析结果\v33_index_data.json', 'w', encoding='utf-8') as f:
