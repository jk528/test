'============================================================
' 四方镜子 - 单模块版 v2（修复错误438）
' 修复：改用更兼容的方式动态创建窗体和控件
' 使用方法：运行 四方镜子_主入口()
'============================================================
...
Sub 四方镜子_主入口()
    ...
    当前连接符号 = "-"
    是否合并模式 = True
    窗体名称 = "frm四方镜_" & Format(Now, "hhmmss")  ' 用时间戳避免重名
    ...
    ' 2. 设置窗体属性（通过代码设置，避免Designer对象438错误）
    With 窗体组件.CodeModule
        .AddFromString 生成窗体代码()
    End With
...
' ============================================================
'  生成窗体的完整代码（包括控件创建）
'  技巧把控件创建放在 UserForm_Initialize 里用代码动态添加
'  这样不依赖 Designer 对象，兼容性更好
' ============================================================
...
Private Function 生成窗体代码() As String
    ...
    代码 = 代码 & "    Me.CommandButton1.SetFocus" & vbCrLf
    ...
    代码 = 代码 & "        CommandButton1.Caption = ""A1B1"" & Chr(10) & ""A1B2"" & Chr(10) & ""A2B1"" & Chr(10) & ""A2B2""" & vbCrLf
    代码 = 代码 & "        CommandButton3.Caption = ""A1B1"" & Chr(10) & ""A2B1"" & Chr(10) & ""A1B2"" & Chr(10) & ""A2B2""" & vbCrLf
    ...
    代码 = 代码 & "    Else" & vbCrLf
    代码 = 代码 & "        CommandButton1.Caption = ""A1  B1"" & Chr(10) & ""A1  B2"" & Chr(10) & ""A2  B1"" & Chr(10) & ""A2  B2""" & vbCrLf
    代码 = 代码 & "        CommandButton3.Caption = ""A1  B1"" & Chr(10) & ""A2  B1"" & Chr(10) & ""A1  B2"" & Chr(10) & ""A2  B2""" & vbCrLf
